...
class BV():
    ...
    def getvideo(self):
        ...
        :return: 无返回值
        """
        api_cid ='https://api.bilibili.com/x/web-interface/view?bvid={}'.format(self.bvid)
        ...
        print("开始下载")
        if len(cids)==1:
            urlhtml = 'https://www.bilibili.com/video/' + self.bvid
            ...
            p=1
            for cid in cids:
                urlhtml = 'https://www.bilibili.com/video/' + self.bvid+"?p="+str(p)
                headersa = {'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
                            'Accept-Encoding': 'gzip, deflate, sdch',
                            'Accept-Language': 'zh-CN,zh;q=0.8',
                            'Cache-Control': 'no-cache',
